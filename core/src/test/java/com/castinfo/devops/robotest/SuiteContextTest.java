...
public class SuiteContextTest {
    ...
    public void testSuiteContext() throws RobotestException {
        ...
        RobotestExecutionContext.getSuites()
                                .put(suiteAnnot,
                                     ctx);
        Mockito.when(stepAnnot.configElements())
               .thenReturn(new RobotestConfig[] {});
        ctx.initStep(ae,
